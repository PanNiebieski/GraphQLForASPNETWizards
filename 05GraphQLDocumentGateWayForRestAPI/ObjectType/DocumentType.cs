...
public class DocumentType : ObjectType<Document>
{
    protected override void Configure(IObjectTypeDescriptor<Document> descriptor)
    {
        ...
        descriptor.Field(d => d.RId).Description("The unique identifier of the document");
...
//public class DocumentViewsChange : ObjectType<DocumentViewStatistics>
//{
//    protected override void Configure(IObjectTypeDescriptor<DocumentViewStatistics> descriptor)
//    {
//        descriptor.Field(d => d.Views).Description("");
//        descriptor.Field(d => d.Date).Description("");
//    }
//}
